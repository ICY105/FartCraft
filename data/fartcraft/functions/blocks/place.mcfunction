...
execute if data storage smithed.custom_block:main blockApi{id:"fartcraft:fart_pipe"} run function fartcraft:blocks/fart_pipe/place
execute if data storage smithed.custom_block:main blockApi{id:"fartcraft:basic_fart_tank"} run function fartcraft:blocks/fart_tank/place_basic
execute if data storage smithed.custom_block:main blockApi{id:"fartcraft:advanced_fart_tank"} run function fartcraft:blocks/fart_tank/place_advanced
