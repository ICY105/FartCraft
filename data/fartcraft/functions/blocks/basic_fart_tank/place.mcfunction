...
summon interaction ~ ~-0.499 ~ {Tags:["fartcraft", "fartcraft.ticking", "fartcraft.basic_fart_tank"], width:1.01f, height:1.01f, Passengers:[{id:"minecraft:item_display", Tags:["fartcraft", "fartcraft.basic_fart_tank.model", "fartcraft.new", "energy.send", "energy.receive"],item:{id:"minecraft:furnace", Count:1b, tag:{CustomModelData:6420500}}}]}

scoreboard players set @e[type=item_display,tag=fartcraft.new,distance=..1] energy.storage 0
scoreboard players set @e[type=item_display,tag=fartcraft.new,distance=..1] energy.max_storage 64
