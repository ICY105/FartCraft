...
execute if score #state fartcraft.data matches 1 if score #energy fartcraft.data < #max_energy fartcraft.data run clear @p[tag=fartcraft.interact,gamemode=!creative] snowball{fartcraft:{id:"fart_in_a_bottle"}} 1
...
execute if score #state fartcraft.data matches 2 if score #energy fartcraft.data matches 1.. run clear @p[tag=fartcraft.interact,gamemode=!creative] glass_bottle 1
