...
summon interaction ~ ~-0.499 ~ {Tags:["fartcraft", "fartcraft.ticking", "fartcraft.fart_tank", "fartcraft.fart_tank.basic"], width:1.01f, height:1.01f, Passengers:[{id:"minecraft:item_display", Tags:["fartcraft", "fartcraft.fart_tank.model", "fartcraft.new", "energy.send", "energy.receive"],item:{id:"minecraft:furnace", Count:1b, tag:{CustomModelData:6420500}}}]}
