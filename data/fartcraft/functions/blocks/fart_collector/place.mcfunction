...
summon interaction ~ ~-0.499 ~ {Tags:["fartcraft", "fartcraft.ticking", "fartcraft.fart_collector"], width:1.01f, height:1.01f, Passengers:[{id:"minecraft:item_display", Tags:["fartcraft", "fartcraft.fart_collector.model", "fartcraft.new", "energy.send"],item:{id:"minecraft:furnace", Count:1b, tag:{CustomModelData:6420503}}}]}
