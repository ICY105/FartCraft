...
execute if score #success fartcraft.data matches 0 run scoreboard players add @e[tag=fartcraft.fart_collector.model,scores={energy.storage=..4},distance=..8,sort=nearest,limit=1] energy.storage 1
